  ...
  "relative box-border inline-flex items-center leading-5 no-underline focus-visible-has:outline-2",
  {
    variants: {
      ...
      variant: {
        ...
        outlined:
          "bg-custom-0 hover:shadow-sm active:shadow-sm-active text-gray-7 outline-offset-0 border hover:bg-custom-1 border-custom-border focus-visible-has:outline-custom-5 current:bg-custom-3 focus-visible-has:border-transparent",
