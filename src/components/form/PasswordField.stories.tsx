...
const formSchema = coerceFormValue(
  z.object({
    password: z._default(z.nullable(z.string()), null),
  }),
);
...
export const WithConform = () => {
  ...
  const value = useFormData(form.id, (formData) => {
    ...
    return result.success ? result.data.password : undefined;
  });
    ...
    <>
      <FormProvider context={form.context}>
        <form {...form.props} method="post">
          <PasswordField label="Password" name={fields.password.name} showScore />
