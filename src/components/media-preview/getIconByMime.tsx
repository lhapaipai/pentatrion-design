...
function iconImage() {
  return (
    <svg
      ...
      height="25"
      viewBox="0 0 25 25"
      className="inline-block h-full w-full overflow-hidden fill-current"
    >
...
export function getIconByMime(fileType: $TSFixMe): $TSFixMe {
  const defaultChoice = {
    color: "#838999",
    icon: iconFile(),
  };
  const undefinedChoice = {
    color: "#838999",
    icon: null,
  };

  if (!fileType) return undefinedChoice;
