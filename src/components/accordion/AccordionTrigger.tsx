...
export function AccordionTrigger({ name, children, ...rest }: Props) {
  ...
  return (
    <button
      ...
      {...rest}
      className="border-l-yellow-4 bg-gray-0 hover:border-l-yellow-4 relative -mt-px flex h-12 w-full cursor-pointer border border-l-4 border-gray-alpha-0 hover:z-1 hover:border-gray-alpha-2"
    >
